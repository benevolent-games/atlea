...
export default template(async basic => {
	...
	return easypage({
		...
		body: html`
			<main>
				<h1 class=banner style="background-image: url('/assets/posters/001.webp')">
					Atlea Game Design
				</h1>
				...
				<h1 class=banner style="background-image: url('/assets/posters/005.webp')">
					The Atlean Archipelago
				</h1>
				...
				<h1 class=banner style="background-image: url('/assets/posters/004.webp')">
				...
				<h1 class=banner style="background-image: url('/assets/posters/003.webp')">
